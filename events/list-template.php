...
<?php endforeach; ?>
    ...
    <form action="<?=url('events/list_by_attendees.php')?>" method="get">
      <fieldset id="contact_field">
    		<legend>Search events with more than your desired number of attendees</legend>
    		<label for="name">Number of attendees:</label>
		    <input type="text" id="num" name="number_attendees"><br>
